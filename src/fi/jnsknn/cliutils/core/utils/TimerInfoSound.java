...
public final class TimerInfoSound {

	private TimerInfoSound() {
	...
	public static void tone(int hz, int msecs, double vol) {
		...
		try {
			...
			Communicator.getInstance().handleError(Constants.LOCAL_CHANNEL, Constants.LOCAL_SENDER,
					"tone error: " + e.getMessage());
		}
	}
}
